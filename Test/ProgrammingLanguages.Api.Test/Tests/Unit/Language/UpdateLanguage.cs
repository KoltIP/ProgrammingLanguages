...
namespace ProgrammingLanguages.Api.Test.Tests.Unit.Language
{
    ...
    {
        [Test]
        public async Task UpdateLanguage_ValidParameters_Success()
        {
            ...
            var model = UpdateLanguageModel(categoryId, "testname", "testDescription");

            await languageService.UpdateLanguage(languageId, model);
